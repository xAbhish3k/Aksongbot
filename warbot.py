...
@Warbot.on_message(filters.private & ~filters.bot & ~filters.command("help") & ~filters.command("start") & ~filters.command("s"))
...
@Warbot.on_message(filters.command("song") & ~filters.edited & filters.group)
async def song(client, message):
    cap = "@WarBotZ"
...
@Warbot.on_message(filters.command("help"))
...
@Warbot.on_callback_query()
async def button(Warbot, update):
      cb_data = update.data
      if "help" in cb_data:
        await update.message.delete()
        await help(Warbot, update.message)
